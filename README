...
⚠️ В реальных условиях Instagram может ограничивать активность ботов. Проект тестируется через mock-тесты и изолированные сценарии.
...
TELEGRAM_BOT_TOKEN=your_telegram_bot_token API_BASE_URL=http://localhost:8000

INSTAGRAM_USERNAME=your_account_username INSTAGRAM_PASSWORD=your_account_password TELEGRAM_BOT_LINK=https://t.me/instagram_tele_tracker_bot TARGET_REELS_ID=your_reels_id
...
Статус проекта
MVP готов. Архитектура протестирована через mock-тесты и готова к масштабированию.